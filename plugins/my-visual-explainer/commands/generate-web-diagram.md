...
---
Load the my-visual-explainer skill, then generate an HTML diagram for: $@

Follow the my-visual-explainer skill workflow. Read the reference template and CSS patterns before generating. Pick a distinctive aesthetic that fits the content — vary fonts, palette, and layout style from previous diagrams.
